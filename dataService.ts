...
const normalizeStatus = (status: string): string => {
  ...
  switch (s) {
    case 'novo lead':
    case 'leads': // for backward compatibility
      return 'novo lead';
    ...
    case 'call realizada':
      return 'call realizada';
    case 'em follow up':
      return 'em follow up';
    case 'ganho':
    case 'venda': // for backward compatibility
      return 'ganho';
    case 'perdido':
    case 'declinou':
    case 'desqualificado':
    ...
    // Legacy statuses mapping to new ones
    case 'em prospecção':
        return 'tentativa de contato';
    case 'reunião de triagem':
        return 'qualificado';
    case 'reunião de proposta':
        return 'call agendada';
    case 'em negociação':
        return 'em follow up';

    default:
      return s; // return as is if not in map, might be a custom status
  }
};
